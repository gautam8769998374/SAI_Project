...
<footer class="bg-gray-100 border-t-2 border-gray-200">
      ...
      <div class="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
        <div>
            ...
            <ul class="text-gray-500 dark:text-gray-400 font-medium">
                <li class="mb-2">
                    <a href="#"class=" text-black cursor-text">Registered Office</a>
                </li>
                <li class="mb-2">
                    <a href="#" class="hover:underline">RDB Boulevard, 8th Floor, Plot K 1, Sector 5, Block EP and GP, Kolkata 700091, India.</a>
                </li>
                <li class="mb-4">
                    <a href="#" class="hover:underline">Milwaukee, Wisconsin
                       U.S.
                    </a>
                </li>
                <li class="mb-2">
                    <a href="#" class="text-black cursor-text ">Contact Us</a>
                </li>
                <li class="mb-1">
        ...
        <div>
            <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Stay Informed</h2>
            <ul class="text-gray-500 dark:text-gray-400 font-medium">
                <li class="mb-4">
                    <input type="text" id="first_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 0" placeholder="email"/>
                </li>
                <li class="mb-4">
        ...
        <div>
            <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Submit Your Query</h2>
            <form>
             <div class="">
                <div>
                    <label for="first_name" class="block text-sm font-medium text-gray-900 dark:text-white">First name</label>
                    <input type="text" id="first_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Gautam" required/>
                </div>
                <div>
                    <label for="last_name" class="block text-sm font-medium text-gray-900 dark:text-white">Last name</label>
                    <input type="text" id="last_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="Rajpurohit" required/>
                </div>
                <div>
                    <label for="visitors" class="block text-sm font-medium text-gray-900 dark:text-white">Phone number</label>
             ...
             <div class="flex items-start mb-6">
                ...
                <label for="remember" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">I agree with the <a href="#" class="text-blue-600 hover:underline ">terms and conditions</a>.</label>
             </div>
              <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Submit</button>
        </form>
        </div>
        <div>
            <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Importent Links</h2>
            <ul class="text-gray-500 dark:text-gray-400 font-medium">
                <li class="mb-4">
    ...
    <div class="px-4 py-6  dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span class="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2023 <a href="/">Sheer Analytics and Insights</a>. All Rights Reserved.
        </span>
