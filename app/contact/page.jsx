...
const Contect = () => {
  return (
       <>
         <section className="bg-white py-20 lg:py-[120px] overflow-hidden relative z-10 m-5 p-5">
                 ...
                 <div className="mb-12 max-w-[570px] lg:mb-0">
                   ...
                   <div className="mb-8 flex w-full max-w-[370px]">
                     ...
                     <div className="w-full">
                       ...
                       <p className="text-base text-body-color">                         sales@sheeranalyticsandinsights.com
                       </p>
                     </div>
                   </div>
                 </div>
                 ...
                 <div className="relative p-8 bg-white rounded-lg shadow-lg sm:p-12">
                   <form>
                     ...
                     <div>
                       <button
                         type="submit"
                         className="bg-gray-700 border-primary w-full rounded-lg border p-3 text-white transition hover:bg-opacity-90"
                       >
                         Send Message
                       </button>
                     </div>
